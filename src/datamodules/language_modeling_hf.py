...
# array_len = 10
# arr = np.memmap('/dfs/scratch0/trid/mmaptest', dtype=np.int32, mode='w+', shape=(10,))
# arr[:] = np.arange(10)
# arr.flush()

# tmp = np.memmap('/dfs/scratch0/trid/mmaptest', dtype=np.int32, mode='r', shape=(10,))

# arr = np.memmap('/dfs/scratch0/trid/mm.txt', dtype=np.int32, mode='w+', shape=(20,))
# arr[:10] = np.arange(10)
# arr.flush()
# arr = np.memmap('/dfs/scratch0/trid/mm.txt', dtype=np.int32, mode='w+', shape=(10,), offset=10)
# arr[:10] = np.arange(10)
# arr.flush()

# tmp = np.memmap('/dfs/scratch0/trid/mm.txt', dtype=np.int32, mode='r', shape=(20,))

# f = open('/dfs/scratch0/trid/mm.txt', 'r+b')
# mm = mmap.mmap(f.fileno(), 0)
# arr = np.ndarray((10,), dtype=np.int32, buffer=mm)
# arr[:] = np.arange(10)
# mm.flush()
# f.close()
...
# f = open('/dfs/scratch0/trid/mm.txt', 'r+b')
# mm = mmap.mmap(f.fileno(), 0)
# arr = np.ndarray((10,), dtype=np.int32, buffer=mm, offset=10*4)
# arr[:] = np.arange(10)
# mm.flush()
# f.close()
...
# f = open('/dfs/scratch0/trid/mm.txt', 'r+b')
# mm = mmap.mmap(f.fileno(), 0)
# arr = np.ndarray((20,), dtype=np.int32, buffer=mm)

# f = open('/dfs/scratch0/trid/mm1.txt', 'w+b')
# mm = mmap.mmap(f.fileno(), 10)

# f = np.lib.format.open_memmap('/dfs/scratch0/trid/mm2.txt', mode='w+', dtype=np.int32, shape=20)
# f[:10] = np.arange(10)
# f.flush()
# f = np.lib.format.open_memmap('/dfs/scratch0/trid/mm2.txt', mode='w+', dtype=np.int32, shape=20)
# f[10:20] = np.arange(10)
# f.flush()
