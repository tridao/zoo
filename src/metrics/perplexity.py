...
# Also adapted from https://github.com/Lightning-AI/metrics/blob/v0.10.0rc/src/torchmetrics/text/perplexity.py
...
class Perplexity(Metric):
    ...
    def update(self, preds: Tensor, target: Tensor, loss: Optional[Tensor] = None) -> None:  # type: ignore
        ...
        self.total_log_probs += loss.to(dtype=self.total_log_probs.dtype) * count
        self.count += count
