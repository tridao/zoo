...
try:
    from src.ops.fused_dense import fused_dense_gelu_dense_function_td
    from src.ops.fused_dense import fused_dense_res_gelu_dense_function_td
except ImportError:
...
class FusedDenseGeluDense(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, bias=True,
                 checkpoint_lvl=0, bf16=False, heuristic=0, return_residual=False,
                 device=None, dtype=None):
        """
