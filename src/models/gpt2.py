...
from src.models.modules.embedding import GPT2Embeddings
...
def create_mixer_cls(config, layer_idx=None):
    ...
    mixer_cls = partial(MHA, num_heads=config.num_attention_heads, dropout=config.attn_pdrop,
                        softmax_scale=softmax_scale, causal=True, fused_bias_fc=fused_bias_fc,
                        use_flash_attn=use_flash_attn, bf16=bf16)
    return mixer_cls
