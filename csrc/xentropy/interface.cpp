...
// at::Tensor softmax_xentropy_inplace_backward(
//     const at::Tensor &grad_loss,
//     at::Tensor &logits,
//     const at::Tensor &max_log_sum_exp,
//     const at::Tensor &labels,
...
//     return softmax_xentropy_inplace_backward_cuda(grad_loss, logits, max_log_sum_exp, labels, smoothing);
// }

// PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
//     m.def("inplace_backward", &softmax_xentropy_inplace_backward, "Softmax cross entropy loss with label smoothing inplace backward (CUDA)");
// }
